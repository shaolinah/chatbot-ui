...
AS $$
DECLARE
  project_url TEXT := 'https://pquduqhloyaehggshjrb.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InBxdWR1cWhsb3lhZWhnZ3NoanJiIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcwNjY4NDAyMCwiZXhwIjoyMDIyMjYwMDIwfQ.vrJdUKpDlBZhV9_0tAPzMZkJ_k7LEGdLw5ViPIum1DM'; -- full access needed for http request to storage
